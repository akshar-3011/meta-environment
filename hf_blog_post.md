...
## ⚠️ The Problem: Static AI Costs Millions
...
- 🛡️ **Regression Testing**: 10 golden scenarios act as a strict regression suite. If a new strategy drops golden-set performance below 90% of baseline, it triggers an automatic retry — preventing catastrophic forgetting.
