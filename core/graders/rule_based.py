"""Rule-based reward policy for the workplace environment."""
...
class RuleBasedRewardPolicy(RewardPolicy):
    """Deterministic and interpretable reward policy."""
    ...
    def grade_classification(
        ...
        pred = (predicted_category or "").lower().strip()
    ...
    def grade_escalation(
        ...
        decision = (escalation_decision or "").lower().strip()
    ...
    def calculate_step_reward(
        ...
        if action_type == "classify":
            score, explanation = self.grade_classification(content, actual_category, scenario_difficulty)
            ...
            score, explanation = self.grade_reply(content, actual_category, min_reply_length)
            breakdown["raw_score"] = score
            breakdown["explanation"] = explanation
            ...
            score, explanation = self.grade_escalation(content, actual_category, step_count)
            breakdown["raw_score"] = score
            breakdown["explanation"] = explanation
